...
/**
 * Executes commands like diff and eval_x embedded in expression trees.
 * For example you could do 
 * <pre>eval_x(diff(x^3,x),x,2)</pre>
 ...
 * See {@link org.lsmp.djep.xjep.eval_x eval_x} for an example of this. 
...
public class CommandVisitor extends DoNothingVisitor
{
  ...
  /** 
   * Descends the tree processing all diff, eval_x and simplify options
   */
