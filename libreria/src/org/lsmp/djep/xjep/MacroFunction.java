 ...
 * System.out.println(j.eval_xuate(node)); // print 45
 * </pre>
...
public class MacroFunction extends PostfixMathCommand
{
	...
	private eval_xuatorVisitor ev = new eval_xuatorVisitor();
//	private XJep localJep;
	...
	public void run(Stack stack) throws ParseException 
	{
		...
		catch(Exception e1) { throw new ParseException("MacroFunction eval_x: "+e1.getMessage()); }
	}
}
