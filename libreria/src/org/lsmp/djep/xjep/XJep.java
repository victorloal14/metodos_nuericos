...
public class XJep extends JEP {
	...
	/** Pre-processes an equation to allow the diff and eval_x operators to be used. */
...
//	public SimplificationVisitor getSimpV() { return simpv; }
	 ...
	 * The result is an ordered sequence, eval_xuating each
	 * variable in turn will correctly allow the final equation to be eval_xuated.
	 * <p>
    ...
    public Object eval_xuate(PostfixMathCommandI pfmc,Node node) throws ParseException {
        // TODO Auto-generated method stub
        return super.eval_xuate(node);
    }
}
