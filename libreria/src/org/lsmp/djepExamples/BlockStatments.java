...
public class BlockStatments extends Console {
	...
	/** eval_xuates a node, but only if the state corresponds to the conditionValue.
	 * Also saves the result of eval_xuation in conditionValue for use in subsequent calls
	 *  
