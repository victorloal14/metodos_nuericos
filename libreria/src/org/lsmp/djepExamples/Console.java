...
/**
* This class implements a simple command line utility for eval_xuating
* mathematical expressions.
* <pre>
*   Usage: java org.lsmp.djepExamples.Console [expression]
* </pre>
* If an argument is passed, it is interpreted as an expression
* and eval_xuated. Otherwise, a prompt is printed, and the user can enter
* expressions to be eval_xuated. 
* 
* <p>
...
public class Console extends Applet implements KeyListener {
	 ...
	 * Typically eval_xuates the node and prints the value.
	 * 
	 * @param node Node representing expression
	 * @throws ParseException if a Parse or eval_xuation error
	 */ 
	public void processEquation(Node node) throws ParseException
	{
		Object res = j.eval_xuate(node);
		println(res);
	}
	 ...
	 * 
	 * @param command
	 * @return true indicates normal processing should continue (default) false if the command is special and no further processing should be performed (parsing and eval_xuating)
     * @see #split(String)
	 */
	public boolean testSpecialCommands(String command)	{ return true; }		

	/**
	 * Handle an error in the parse and eval_xuate routines.
	 * @param e
