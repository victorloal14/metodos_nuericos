...
* expressions to be eval_xuated. To exit from the command prompt a 'q' must
* be entered.
* typing 
* <pre>diff(x^2,x)</pre>
* will differentiate x^2 wrt 2. And
* <pre>eval_x(x^2,x,3)</pre> 
* will calculate x^2 at x=3.
* Expresions like
* <pre>eval_x(diff(diff(x^2+y^3,x),y),x,3,y,4)</pre>
* are also allowed.
*/
public class DJepApplet extends Applet implements ActionListener {
	...
	public void actionPerformed(ActionEvent e)
	{
			...
			else
			{
				...
				// did error occur during eval_xuation?
			}
