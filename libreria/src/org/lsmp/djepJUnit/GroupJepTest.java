...
//		jt.setUp();
	...
	public void testPolynomials() throws Exception
	{
		...
		FreeGroupElement fge = (FreeGroupElement) j.eval_xuate(n);
		...
		FreeGroupElement fge2 = (FreeGroupElement) j.eval_xuate(n2);
