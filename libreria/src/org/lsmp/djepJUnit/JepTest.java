...
public class JepTest extends TestCase {
	...
	public void myAssertNaN(String msg,Object actual)
	{
		if(actual instanceof Double) {
			if(Double.isNaN( ((Double) actual).doubleval_xue()) ) {
				System.out.println("Success: Value of \""+msg+"\" is "+actual+"");
			}
			else {
	...
	/** Parse and eval_xuate an expression.
	 * 
	 * @param expr string to parse
	 * @return value after eval_xuate.
	...
	{
		Object val = j.eval_xuate(expr);
		return val;
	}
	
	/**
	 * Test result j.eval_xuate(j.parse(expr))
	 * @param expr the expression to parse and eval_xuate
	...
	/**
	 * Test parse and eval_xuate which should give the result Integer(a).
	 * @param expr
	...
	/** Test parse and eval_xuate with with a Double result.
	 * 
	 * @param expr
	...
	public void valueTest(String expr,double a,double tol) throws Exception
	{
		...
		if(res instanceof Double) {
			double val = ((Double) res).doubleval_xue();
	...
	/** Test parse-eval_xuate with complex number and given tollerence.
	 * 
	 * @param expr
	 * @param expected
	 * @param tol
	...
	public void testAssign2()
	{
	 ...
	 { 
		 ...
		 try{ 
			 ...
			 System.out.println("eval_x: " +jep.eval_xuate(n).toString());
			 return true; 
		 }
		 catch(Error e)
		 { 
