...
public interface eval_xuatorI {
	...
	/**
	 * eval_xuates a node and returns and object with the value of the node.
	 * 
	 * @throws ParseException if errors occur during eval_xuation;
	 */
	public abstract Object eval_x(Node node) throws ParseException;
}
