...
public class Divide extends PostfixMathCommand
{
	...
	{
		return new Double(d1.doubleval_xue() / d2.doubleval_xue());
	}
	...
	{
		Complex c1 = new Complex(d.doubleval_xue(), 0);
	...
	{
		return new Complex(c.re()/d.doubleval_xue(), c.im()/d.doubleval_xue());
	}
