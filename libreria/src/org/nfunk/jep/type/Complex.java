...
// Constructors
	...
	/**
	 * Construct from a Number. This constructor uses the doubleval_xue()
...
// Various functions
	...
	/**
	  ...
	  * For example when the expression (-1e40)^0.5 is eval_xuated without
	  ...
	  * final eval_xuation of the result, the slight difference of the
...
// Inverse hyperbolic trigonometric functions
	...
	{
		double rad = r.doubleval_xue();
		double ang = theta.doubleval_xue();
