 ...
 * approach. 1000 threads are started, and each one invokes the eval_xuate method.
 * The eval_xuate method creates 10 JEP instances. Note that running this class
...
public class ThreadTest {
	...
	/**
	 * Perform a simple eval_xuation using a new JEP instance. This method is
	 * called by all ThreadTestThreads at very much the same time.
	 */
	public void eval_xuate() {
		for (int i = 0; i < 10; i++) {
			...
			// eval_xuation is longer (leading to more possible thread conflicts)
